...
localparam [7:0] FAM_MCR2 = 8'd1, FAM_MCR3 = 8'd2, FAM_SCROLL = 8'd3;
...
wire dl_cpu_rng = dl_v2 && !dl_hi && (dl_addr[17:16] == 2'b00);
wire dl_snd_rng = dl_v2 && !dl_hi && (dl_addr[17:14] == 4'b0100);
wire dl_bg1_rng = dl_v2 && !dl_hi && (ldr_is_mcr2 ? (dl_addr[17:13] == 5'b01110)
                                                  : (dl_addr[17:14] == 4'b0101));
wire dl_bg2_rng = dl_v2 && !dl_hi && (ldr_is_mcr2 ? (dl_addr[17:13] == 5'b01111)
...
always @(*) begin
    ...
    default: ;   // roster indices beyond the 12 games
    endcase
...
wire [14:0] m3_sp_addr, ms_sp_addr;
wire        ms_halt_n;
...
assign r           = run_is_mcr3 ? m3_r : run_is_scroll ? ms_r : m2_r;
assign g           = run_is_mcr3 ? m3_g : run_is_scroll ? ms_g : m2_g;
assign b           = run_is_mcr3 ? m3_b : run_is_scroll ? ms_b : m2_b;
assign vblank      = run_is_mcr3 ? m3_vblank : run_is_scroll ? ms_vblank : m2_vblank;
assign hblank      = run_is_mcr3 ? m3_hblank : run_is_scroll ? ms_hblank : m2_hblank;
assign hs          = run_is_mcr3 ? m3_hs     : run_is_scroll ? ms_hs     : m2_hs;
assign vs          = run_is_mcr3 ? m3_vs     : run_is_scroll ? ms_vs     : m2_vs;
assign cs          = run_is_mcr3 ? m3_cs     : run_is_scroll ? ms_cs     : m2_cs;
assign core_hcnt   = run_is_mcr3 ? m3_hcnt   : run_is_scroll ? ms_hcnt   : m2_hcnt;
assign core_vcnt   = run_is_mcr3 ? m3_vcnt   : run_is_scroll ? ms_vcnt   : m2_vcnt;
assign audio_l_val = run_is_mcr3 ? m3_al     : run_is_scroll ? ms_mix_l  : m2_al;
assign audio_r_val = run_is_mcr3 ? m3_ar     : run_is_scroll ? ms_mix_r  : m2_ar;
assign rom_addr    = run_is_mcr3 ? m3_rom_addr : run_is_scroll ? ms_rom_addr : m2_rom_addr;
assign snd_addr    = run_is_mcr3 ? m3_snd_addr : run_is_scroll ? ms_snd_addr : m2_snd_addr;
