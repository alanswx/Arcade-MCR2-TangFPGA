...
mcr2 #(
    ...
    .video_vblank(p_vblank), .video_hblank(p_hblank),
    .video_hs(p_hs), .video_vs(p_vs), .video_csync(p_cs),
    .hcnt_out(p_hcnt), .vcnt_out(p_vcnt),
    .tv15Khz_mode(tv15khz),
    .separate_audio(1'b0), .audio_out_l(p_al), .audio_out_r(p_ar),
...
uart_beacon #(.CLK_HZ(40_000_000), .BAUD(115200)) beacon (
    ...
    .aux2({spq_nonff_s ^ probe_syn ^ (^probe_rgb), hb_h[23], usb_typ_s2, sd_ready, sd_err, ldr_done, ldr_error}),
    .txd(beacon_txd)
);
