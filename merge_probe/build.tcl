...
set_option -output_base_name merge_probe
set_option -top_module merge_probe_top
...
# Add source files
add_file src/merge_probe_top.sv
...
add_file -type cst src/merge_probe.cst
add_file -type sdc src/merge_probe.sdc
