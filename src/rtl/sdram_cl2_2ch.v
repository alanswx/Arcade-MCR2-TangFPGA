// VENDORED 2026-07-24 from nand2mario/snestang src/sdram_cl2_2ch.v (unmodified)
// for the SDRAM retention experiment: does the KNOWN-GOOD controller retain
// data on our Tang SDRAM module where sdram_gw does not? Note snestang drives
// the SDRAM clock PIN from a 225-degree phase-shifted PLL output directly
// (assign O_sdram_clk = fclk_p) - NOT an ODDR at 0 degrees like sdram_gw.
//
