...
set_option -output_base_name ddr3_avltest
set_option -top_module ddr3_avltest_top
...
# Top + test source
add_file src/ddr3_avltest_top.sv
add_file ../src/ascal/avl_ddr3_memtest.sv
...
add_file -type cst src/ddr3_avltest.cst
add_file -type sdc src/ddr3_avltest.sdc
