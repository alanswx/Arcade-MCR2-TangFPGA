...
set_option -output_base_name ascal_ghdlnl
set_option -top_module ascal_ghdlnl_top
...
# Top + test source
add_file src/ascal_ghdlnl_top.sv
add_file ../src/testpat/mcr_testpattern.sv

# ascal (unmodified upstream) + our wrapper and Avalon->Gowin DDR3 bridge
# GHDL-synthesised Verilog netlist of ascal_gw, in place of the VHDL.
# Same logic, but it bypasses GowinSynthesis VHDL front-end entirely.
# Verified correct under verilator: 8 bars of 80 px across the window.
add_file ../src/ascal/ascal_gw_synth.v
